		...
		<section id="about">
			...
			>
				<p>
					...
					послуг від 02.06.2020 року № 1124(Свідоцтво про реєстрацію фінансової
					установи ФК №В0000140 від 18.01.2021), господарська діяльність якого
					полягає у наданні фінансових послуг:
				</p>
				...
				<p>
					...
					не здійснює надання фінансових послуг фізичним особам, а саме не
					здійснює надання коштів у кредит та/або надання послуг факторингу
					та/або надання послуг фінансового лізингу фізичним особам-споживачам
					та/або врегулювання простроченої заборгованості з фізичними-особами
