...
export const infoOwnershipStructure: IDocumentsListGroup[] = [
	{
		...
		list: [
			{
				title:
					'Схематичне зображення структури власності ТОВ "ЛАЙТ ФІНАНС" станом на 01.01.2025',
				link: importDoc('1_Struktura vlasnosti TOV LAIT FINANS na 01.01.2025.pdf'),
			},
			{
				title:
...
export const financeReports: IDocumentsListGroup[] = [
	{
		...
		list: [
			{
				title: 'Баланс (Звіт про фінансовий стан) на 30 червня 2025р..pdf',
				link: importDoc('Баланс (Звіт про фінансовий стан) на 30 червня 2025р..pdf'),
			},
			{
				title: 'Звiт про рух грошових коштiв (за прямим методом) за I півріччя 2025р..pdf',
				link: importDoc('Звiт про рух грошових коштiв (за прямим методом) за I півріччя 2025р..pdf'),
			},
			{
				title: 'Звіт про власний капітал за I півріччя 2025р..pdf',
				link: importDoc('Звіт про власний капітал за I півріччя 2025р..pdf'),
			},
			{
				title: 'Звіт про фінансові результати (Звіт про сукупний дохід) за I півріччя 2025р..pdf',
				link: importDoc('Звіт про фінансові результати (Звіт про сукупний дохід) за I півріччя 2025р..pdf'),
			},
			{
				title: 'Примітки до фінансової звітності ТОВ Лайт Фінанс за 1 півріччя 2025 р..pdf',
				link: importDoc('Примітки до фінансової звітності ТОВ Лайт Фінанс за 1 півріччя 2025 р..pdf'),
			},
			{
	...
	},
	{
		...
		list: [
			...
			{
				title: 'Примітки до фінансової звітності ТОВ ЛАЙТ ФІНАНС за 2024р.',
				link: importDoc(
					'Примітки до фінансової звітності ТОВ ЛАЙТ ФІНАНС за 2024р..pdf',
				),
			},
			{
				title: 'Баланс (Звіт про фінансовий стан) на 31 грудня 2024 ЛФ',
				link: importDoc(
					'Баланс (Звіт про фінансовий стан) на 31 грудня 2024 ЛФ.pdf',
				),
			},
			{
				title: 'Звіт про власний капітал за 2024 ЛФ',
				link: importDoc('Звіт про власний капітал за 2024 ЛФ.pdf'),
			},
			{
				title: 'Звіт про рух грошових коштів (за прямим методом) за 2024 ЛФ',
				link: importDoc(
					'Звіт про рух грошових коштів (за прямим методом) за 2024 ЛФ.pdf',
				),
			},
			{
				title:
					'Звіт про фінансові результати (Звіт про сукупний дохід) за 2024р. ЛФ',
				link: importDoc(
					'Звіт про фінансові результати (Звіт про сукупний дохід) за 2024р. ЛФ.pdf',
				),
			},
		],
	},
